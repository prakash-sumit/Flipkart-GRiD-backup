//everything in task4 is now easily debugable just last two if conditions have wierd positions
//task1 : x and z motors running together
// theta motor delay is lesser in the code : delay(5)  -> not working 
//theta motor delay(10) used here  
//tested for 5 loops. theta motor nahi hagta

//till test3 stepsize(x,y,z) = (800,6400,800)
#include <ros.h>
...
if (counter_y == 5 && counter_z==5 && counter_x ==5) {  
...
//        delay(1000);
        counter_z =8;
        counter_x =8; 
        counter_y =8;                  //10 is the counter to make every motor back to initial position
}
