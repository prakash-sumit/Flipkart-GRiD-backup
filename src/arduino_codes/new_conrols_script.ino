...
if(counter_z==0 && counter_x ==0) {          //all motors set to reach final position
  ...
  steps_z = final_z - steps_z;             //thoda haga he
...
if(counter_z == 4 ){ 
    ...
    counter_x = 14;
    counter_y = 14;
    nh.loginfo ("z reaches the (final_z - steps_z) position");   //this final_z - steps_z = 0 position but if final_z increases while turning theta it may collide
...
if (counter_y == 14) {  
  ...
  counter_y= 16;  
   nh.loginfo ("y reaches the final_y - steps_y position");   
    // delay(500) ;
...
if(yaw_msg == 1) {
  ...
  motor3.move(final_z);           //set z for final location
